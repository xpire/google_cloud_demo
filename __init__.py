...
train_file = 'demo/input/train.csv'
test_file = 'demo/input/test.csv'
store_file = 'demo/input/store.csv'
output_file = 'demo/output/new_rossmann_prediction.csv'
output_train = 'demo/output/trainPartitioned.csv'
output_test = 'demo/output/testPartitioned.csv'
