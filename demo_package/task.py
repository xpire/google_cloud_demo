...
# example on new project:
# gcloud ml-engine jobs submit training TRIALJOB10 \
# --runtime-version=1.11 \
# --python-version 3.5 \
# --region=us-central1 \
# --module-name=demo_package.task \
# --job-dir=gs://cbdsolutions_big_data_demo_sales_data/cloudml_training/ \
# --scale-tier=BASIC  \
# --package-path=demo_package \
# -- \
#   --train_data_paths="gs://cbdsolutions_big_data_demo_sales_data/trainPartitioned.csv" \
#   --eval_data_paths="gs://cbdsolutions_big_data_demo_sales_data/testPartitioned.csv" \
#   --output_dir="model_check" --store_data_path="gs://cbdsolutions_big_data_demo_sales_data/store.csv" \
#   --original_train_data_path="gs://cbdsolutions_big_data_demo_sales_data/train.csv" \
#   --storage_type="gcs"

# non condensed:
# gcloud ml-engine jobs submit training TRIALJOB11 --runtime-version=1.11 --python-version 3.5 --region=us-central1 --module-name=demo_package.task --job-dir=gs://cbdsolutions_big_data_demo_sales_data/cloudml_training/ --scale-tier=BASIC  --package-path=demo_package -- --train_data_paths="gs://cbdsolutions_big_data_demo_sales_data/trainPartitioned.csv" --eval_data_paths="gs://cbdsolutions_big_data_demo_sales_data/testPartitioned.csv" --output_dir="model_check" --store_data_path="gs://cbdsolutions_big_data_demo_sales_data/store.csv" --original_train_data_path="gs://cbdsolutions_big_data_demo_sales_data/train.csv" --storage_type="gcs"
